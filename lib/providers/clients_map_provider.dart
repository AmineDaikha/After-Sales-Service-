...
class ClientsMapProvider extends ChangeNotifier {
  ...
  List<Client> mapClientsWithCommandsInterventions = [
  ];
  ...
  List<Client> getOppoByStat(int stat){
    return mapClientsWithCommandsInterventions.where((client) => client.stat == stat).toList();
  }
