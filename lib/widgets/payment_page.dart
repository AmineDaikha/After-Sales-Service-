...
class _PaymentPageState extends State<PaymentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        'etabl: ${AppUrl.user.etblssmnt!.code} and pcf code: ${widget.client.id}');
                            ...
                            onPressed: () async {
                              if (formKey.currentState != null &&
                                ...
                                if (payments.paymentListSelected.isEmpty) {
                                  showMessage(
                                      message: 'Choisir en moins une échéances',
                                      context: context,
                                      color: Colors.red);
...
class _CurrentPaymentWidgetState extends State<CurrentPaymentWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    if (widget._numberController.text.trim().isNotEmpty ||
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text(
          '${AppUrl.formatter.format(widget.payments.restPayment(widget._numberController.text.trim()))} DZD',
          style: Theme.of(context)
              .textTheme
              .headline3!
              ...
              children: [
                Checkbox(
                  ...
                  onChanged: (value) {
                    //provider.notifyListeners();
                    print(
                        'value ${widget.numberController.text.trim()} restPayment: ${provider.restPayment(widget.numberController.text.trim())}');
                    ...
                    setState(() {
                      ...
                      print(
                          'seleted size: ${provider.paymentListSelected.length}');
                      widget.currentPaymentWidgetKey.currentState
                          ?.setState(() {});
                      widget.affectedPaymentWidgetKey.currentState
                          ?.setState(() {});
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'Le reste : ${AppUrl.formatter.format(widget.payment.currrentRest)} DZD',
                      style: Theme.of(context)
                          .textTheme
                          .headline5!
                          .copyWith(color: primaryColor),
                    ...
                    Text(
                        'Total : ${AppUrl.formatter.format(widget.payment.total)} DZD',
                        style: Theme.of(context)
                            .textTheme
                            .headline6!
                ...
                Text(
                  ' ${DateFormat('yyyy-MM-dd HH:mm:ss').format(widget.payment.date!)} ',
                  style: Theme.of(context)
                      .textTheme
                      .bodyText1!
