...
class ReclamationListPage extends StatefulWidget {
  ...
  const ReclamationListPage({super.key, required this.callback, required this.client});
...
class _ReclamationListPageState extends State<ReclamationListPage> {
  ...
  Future<void> fetchData() async {
    ...
    String url = AppUrl.reclamation +
        '?pcfCode=${widget.client.id}&dateDebut=${DateFormat('yyyy-MM-ddT00:00:00').format(AppUrl.filtredOpporunity.date)}&dateFin=${DateFormat('yyyy-MM-ddT23:59:59').format(AppUrl.filtredOpporunity.dateEnd)}&salCode=${collaborator}';

    if (AppUrl.filtredOpporunity.clinet != null &&
        AppUrl.filtredOpporunity.article == null) {
      url = AppUrl.reclamation +
          '?pcfCode=${widget.client.id}&dateDebut=${DateFormat('yyyy-MM-ddT00:00:00').format(AppUrl.filtredOpporunity.date)}&dateFin=${DateFormat('yyyy-MM-ddT23:59:59').format(AppUrl.filtredOpporunity.dateEnd)}&salCode=${collaborator}&pcfCode=${AppUrl.filtredOpporunity.clinet!.id}';
    }
    if (AppUrl.filtredOpporunity.clinet != null &&
        AppUrl.filtredOpporunity.article != null) {
      url = AppUrl.reclamation +
          '?pcfCode=${widget.client.id}&dateDebut=${DateFormat('yyyy-MM-ddT00:00:00').format(AppUrl.filtredOpporunity.date)}&dateFin=${DateFormat('yyyy-MM-ddT23:59:59').format(AppUrl.filtredOpporunity.dateEnd)}&salCode=${collaborator}&pcfCode=${AppUrl.filtredOpporunity.clinet!.id}&numSerie=${AppUrl.filtredOpporunity.article!.numSerie}';
    }
    // String url = AppUrl.reclamation +
