...
import 'package:sav_app/screens/clients_page/client_history_page.dart';
import 'package:sav_app/screens/clients_page/edit_client_page.dart';
...
import 'package:sav_app/widgets/drawers/clients_drawer.dart';
        ...
        builder: (context, snapshot) {
          ...
          return Consumer<ClientsMapProvider>(
            ...
            if (widget.type == 'P')
              ...
              tiers = 'clients';
            else if (widget.type == 'F') tiers = 'fournisseurs';
