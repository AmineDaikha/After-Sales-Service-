...
import 'package:sav_app/screens/activities_pages/add_activity_page.dart';
import 'package:sav_app/screens/home_page/GoogleMapPage.dart';
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () {
                                    if (widget.client.res['adress'] != null) {
                                      PageNavigator(ctx: context).nextPage(
                                          page: AddressesPage(
                                              client: widget.client));
                                    } else {
