...
class _EditClientPageState extends State<EditClientPage> {
  ...
  Future<bool> sendEditClient(Client client) async {
    ...
    try {
      if (client.res['adress'] != null) {
        client.res['adress'][0]['longitude'] = client.location!.longitude;
        client.res['adress'][0]['latitude'] = client.location!.latitude;
        client.res['adress'][1]['longitude'] = client.location!.longitude;
        client.res['adress'][1]['latitude'] = client.location!.latitude;
      }
    } catch (_) {}
