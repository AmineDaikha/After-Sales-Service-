...
class ReclamationHistoryFragment extends StatefulWidget {
  Client client;

  ReclamationHistoryFragment({super.key, required this.client});

  @override
  State<ReclamationHistoryFragment> createState() =>
      _ReclamationHistoryFragmentState();
}

class _ReclamationHistoryFragmentState
    extends State<ReclamationHistoryFragment> {
  ...
  Future<void> fetchData() async {
    ...
    print("res hisRec code : ${req.statusCode}");
    print("res hisRec body: ${req.body}");
                    ...
                    return Expanded(
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => InkWell(
                              ...
                              child: ClientItem(
                                  client: clients.mapClientsWithCommands
                                      .toList()[index])),
