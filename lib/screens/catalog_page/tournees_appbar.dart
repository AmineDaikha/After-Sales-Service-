...
import 'package:sav_app/screens/home_page/add_intervention_page.dart';
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      actions: [
        IconButton(
            onPressed: () {
              PageNavigator(ctx: context).nextPage(page: AddInerventionPage());
            },
            icon: Icon(
              Icons.add,
              color: Colors.white,
            ...
            onPressed: () {
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return FiltredOpportunitiesDialog(type: 'intervention');
                },
              );
            },
            icon: Icon(
