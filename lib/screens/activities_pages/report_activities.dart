...
class _ReportedActivitiesDialogState extends State<ReportedActivitiesDialog> {
  ...
  void initState() {
    ...
    if(widget.activity.dateEnd != null && widget.activity.dateStart != null){
      difference = widget.activity.dateEnd!.difference(widget.activity.dateStart!);
      print('diff: ${difference.inMinutes}');
    }
  }
  ...
  Future<void> showDateTimeDialog(BuildContext context, String type) async {
    ...
    if (type == 'start'){
      init = selectedStartTimeDate;
    }else {
      init = selectedEndTimeDate;
    }
    selectedDate = await showDatePicker(
        context: context,
        initialDate: init,
    ...
    if (selectedDate != null) {
      // Show time picker
      TimeOfDay initTime = TimeOfDay.fromDateTime(init);
      ...
      if (selectedTime != null) {
        ...
        if (type == 'start'){
          selectedStartTimeDate = selectedDateTime;
          DateTime copie = DateTime(
            selectedStartTimeDate.year,
            selectedStartTimeDate.month,
            selectedStartTimeDate.day,
            selectedStartTimeDate.hour,
            selectedStartTimeDate.minute,
            selectedStartTimeDate.second,
            selectedStartTimeDate.millisecond,
            selectedStartTimeDate.microsecond,
          );
          selectedEndTimeDate = copie.add(difference);
        }
        else
          selectedEndTimeDate = selectedDateTime;
        print('date:: $type');
