                                  ...
                                  onTap: () {
                                    ...
                                    final provider =
                                        Provider.of<ClientsMapProvider>(context,
                                            listen: false);
                                    if (isVisited == false) {
                                      clients = provider.mapClientsWithCommandsInterventions;
                                    } else {
                                      clients = provider.mapClientsWithCommandsInterventions;
                                    }
                                    print(
                        ...
                        if (isVisited) {
                          ...
                          return ListView.separated(
                              itemBuilder: (context, index) {
                                return clientItem(
                                    client: clients.mapClientsWithCommandsInterventions[index]);
                              },
                              separatorBuilder:
...
class _ToVisitState extends State<ToVisit> {
  ...
  void initState() {
    ...
    //provider.updateList();
    print('provider list size: ${provider.mapClientsWithCommandsInterventions.length}');
    for (Client client in provider.mapClientsWithCommandsInterventions) {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      return Container(
                        ...
                        onTap: () {
                          PageNavigator(ctx: context).nextPage(
                              page: OpportunityPage(
                                  client: provider.mapClientsWithCommandsInterventions[i - 1]));
                        },
        ...
        //         );
        //       }
        //       String data = provider.mapClientsWithCommandsInterventions[index - 1].name!;
            ...
            IconButton(
                onPressed: () {
                  if (client.phone != null)
                    ...
                    _showAlertDialog(
                        context, 'Aucune numéro de téléphone pour ce client');
                },
                icon: Icon(
                  Icons.call_outlined,
                  color: Colors.grey,
