...
class DelivreyView extends StatefulWidget {
  Client client;

  DelivreyView({super.key, required this.client});

  @override
  State<DelivreyView> createState() => _DelivreyViewState();
}

class _DelivreyViewState extends State<DelivreyView> {
