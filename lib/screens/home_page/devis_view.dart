...
class DevisView extends StatefulWidget {
  Client client;

  DevisView({super.key, required this.client});

  @override
  State<DevisView> createState() => _DevisViewState();
}

class _DevisViewState extends State<DevisView> {
  ...
  Future<void> fetchData() async {
    String url =
        AppUrl.getDocs + '?interNumero=${widget.client.resOppo['numero']}';
    print('urlis: $url');
