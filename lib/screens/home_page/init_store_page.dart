...
class _StorePageState extends State<StorePage> {
  ...
  Future<void> fetchData() async {
    final provider = Provider.of<ProductProvider>(context, listen: false);
    provider.allProducts = [];
    String url = AppUrl.articles + '?type=R,O&PageNumber=1&Filter=$filter&PageSize=20';
        ...
        child: FloatingActionButton(
          onPressed: () {
            if (widget.client.command!.nbProduct > 0) {
              widget.client.command!.type = widget.type;
  ...
  Future<void> fetchData(BuildContext context) async {
    ...
    http.Response req = await http.get(
        Uri.parse(AppUrl.articlesFromDepotPage +
            ...
            '?type=R,O&PageNumber=1&Filter=$query&PageSize=20'),
        headers: {
          "Accept": "application/json",
          "content-type": "application/json; charset=UTF-8",
          "Referer": "http://" + AppUrl.user.company! + ".localhost:4200/"
