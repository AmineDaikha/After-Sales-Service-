...
import 'package:sav_app/widgets/appbars/tournees_appbar.dart';
import 'package:sav_app/widgets/drawers/home_drawer.dart';
import 'calander_fragment.dart';
import 'calander_fragment.dart';
import 'clients_list_fragment.dart';
import 'itineraire_fragment.dart';
import 'pipline_fragment.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    //     print('size of list: ${provider.mapClientsWithCommandsInterventionsInterventions}');
  ...
  Future<void> fetchDataNumSerie() async {
    print('debuginggg');
    final provider = Provider.of<ClientsMapProvider>(context, listen: false);
    provider.mapClientsWithCommandsInterventions = [];
    int? equipe;
