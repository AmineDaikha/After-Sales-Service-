...
import 'package:sav_app/widgets/collaborator_page.dart';
import 'package:sav_app/widgets/confirmation_dialog.dart';
import 'package:sav_app/widgets/contacts_page.dart';
...
class _AddActivityPageState extends State<AddActivityPage> {
  ...
  Future<bool> sendActivity(BuildContext context, Activity activity) async {
    ...
    Map<String, dynamic> jsonObject = {
      ...
      "motifAnnul": null,
      "usrdelete": null,
      "interNumero": activity.client.idOpp,
      "contacts": contacts,
      "users": users
    };

    print('jsonObj: ${jsonObject['interNumero']}');
