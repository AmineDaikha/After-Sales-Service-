...
//import 'package:sav_app/screens/activities_pages/notes_page/title_note_dialog.dart';
import 'package:sav_app/screens/notes_page/text_note_page.dart';
import 'package:sav_app/screens/notes_page/video_page.dart';
...
class _AddTextNotePageState extends State<AddTextNotePage> {
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Container(
                            child: ItemFileNote(
                                fileNote: widget.note.files[index]));
                      },
                    ),
                  ),
                ],
  ...
  Future<bool> sendNote(BuildContext context, Note note) async {
    ...
    Map<String, dynamic> jsonObject = {
      ...
      "usersNotes": users,
      "interNumero": '${widget.client!.idOpp}',
    };
    ...
    if (req.statusCode == 200 || req.statusCode == 201) {
      ...
      for (int i = 0; i < note.files.length; i++)
        await uploadFile(res['id'].toString(), note.files[i].path)
            .then((value) {
          if (value)
            addNote = true;
          else
