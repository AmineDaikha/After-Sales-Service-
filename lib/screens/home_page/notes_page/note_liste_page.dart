...
class _NoteListPageState extends State<NoteListPage> {
  ...
  Future<void> fetchData() async {
    ...
    String url = AppUrl.getAllNotes + '?interNumero=' + widget.client.idOpp!;
                ...
                appBar: AppBar(
                  ...
                  title: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'du : ${DateFormat('yyyy-MM-dd').format(AppUrl.filtredCommandsClient.date)}, de : ${AppUrl.filtredCommandsClient.collaborateur!.userName}',
