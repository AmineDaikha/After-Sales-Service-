...
class _NewCommandPageState extends State<NewCommandPage> {
                  ...
                  _getCurrentLocation().then((value) {
                    if (value) {
                      ...
                      PageNavigator(ctx: context)
                          .nextPage(
                              page: AddInerventionPage(
                        client: widget.client,
                      ))
                          .then((value) {
                        print('value is: ${widget.client.idOpp}');
  ...
  Future<void> sendDocument(BuildContext context) async {
    ...
    for (Product product in widget.client.command!.products) {
      if (product.quantityOfColis == null)
        product.quantityOfColis = 1;
    ...
    if (req.statusCode == 200 || req.statusCode == 201) {
      ...
      showMessage(
          message: 'Commande / Devis créé(e) avec succès',
          context: context,
          color: primaryColor);
      ...
      showMessage(
          message: 'Échec de creation de commande / devis',
          context: context,
          color: Colors.red);
    }
  }
