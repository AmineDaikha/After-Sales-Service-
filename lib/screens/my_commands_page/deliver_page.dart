...
import 'package:sav_app/providers/depot_provider.dart';
import 'package:sav_app/providers/product_provider.dart';
import 'package:sav_app/screens/home_page/store_page.dart';
                    ...
                    IconButton(
                      onPressed: () async {
                        if (widget.client.email != null) {
                          ...
                          await httpRequestApp
                              .sendEmail(widget.client.command!.id!,
                                  widget.type, '${widget.client.email}')
                              .then((value) {
                            if (value) {
                              showMessage(
                          ...
                          showAlertDialog(context, 'Pas email pour ce client');
                        }
                      },
                      icon: Icon(
                        Icons.send_outlined,
